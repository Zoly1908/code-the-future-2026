...
//  Senzori: DHT22, MPU6050, MQ-3
//  Actuatori: Releu ventilator, LED verde/galben/rosu, Buzzer
//  Comunicatie: WiFi + MQTT
// ============================================================
...
#define MQ3_PIN       0       // MQ-3 AOUT -> GPIO0 (ADC)

#define RELAY_PIN     23      // Releu ventilator
#define LED_GREEN     18      // LED Verde  -> totul OK
#define LED_YELLOW    19      // LED Galben -> temperatura ridicata
#define LED_RED       20      // LED Rosu   -> pericol
#define BUZZER_PIN    21      // Buzzer activ

// MPU6050 foloseste I2C
// SDA -> GPIO8  (default I2C pe ESP32-C6)
// SCL -> GPIO9  (default I2C pe ESP32-C6)

// ============================================================
//  PRAGURI
// ============================================================
#define TEMP_WARN         28.0f   // °C  -> LED galben + ventilator
#define TEMP_CRITICAL     35.0f   // °C  -> LED rosu + buzzer
#define HUM_WARN          70.0f   // %   -> avertizare umiditate
#define GAS_WARN          400     // raw ADC (0-4095) ~calibrare MQ-3
#define VIBRATION_WARN    0.8f    // g   -> acceleratie deviere fata de repaus
...
void setup() {
  ...
  Wire.begin(); // SDA=8, SCL=9 default ESP32-C6
  mpu.initialize();
  if (!mpu.testConnection()) {
    Serial.println("[WARN] MPU6050 nu a fost gasit!");
  } else {
  ...
  Serial.println("=== Sistem pornit cu succes ===\n");
}
...
// ============================================================
//  CALIBRARE MPU — media primelor 50 citiri
// ============================================================
void calibrateMPU() {
